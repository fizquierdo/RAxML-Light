...
int findFreeSlot(recompVectors *v, int mxtips)
{
...
boolean isNodePinned(recompVectors *rvec, int nodenum, int mxtips)
{
...
int pinNode(recompVectors *rvec, int nodenum, int mxtips)
{
  int slot, i;
...
int findUnpinnableSlot(recompVectors *v, int mxtips)
{
  int i, slot;
  int node_unpinned;
  int slot_unpinned = -1;
